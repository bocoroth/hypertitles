...
const testTableData = [
  {
    ...
    lengthMS: 3000,
    cssClass: 'md',
    line: 'Lorem ipsum dolor sit amet consectetur adipiscing elit velit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'
  },
  {
    lineNumber: 2,
    start: '00:00:05,000',
...
<template>
  <div class="line-list-module">
    <Datatable
      :value="testTableData"
      class="p-datatable-sm d-flex flex-column"
